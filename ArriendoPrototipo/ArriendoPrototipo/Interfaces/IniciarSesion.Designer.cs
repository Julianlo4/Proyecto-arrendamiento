namespace ArriendoPrototipo.Interfaces
{
    partial class IniciarSesion
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbx_contrasenia = new Apariencia.CustomTextBox();
            cbx_NombreUsuario = new Apariencia.CustomTextBox();
            ...
            pnlPrincipal.Controls.Add(cbx_contrasenia);
            pnlPrincipal.Controls.Add(cbx_NombreUsuario);
            ...
            // cbx_contrasenia
            // 
            cbx_contrasenia.BackColor = SystemColors.Window;
            cbx_contrasenia.BorderColor = Color.Black;
            cbx_contrasenia.BorderFocusColor = Color.HotPink;
            cbx_contrasenia.BorderRadius = 0;
            cbx_contrasenia.BorderSize = 2;
            cbx_contrasenia.Cursor = Cursors.IBeam;
            cbx_contrasenia.ForeColor = Color.DimGray;
            cbx_contrasenia.Location = new Point(426, 371);
            cbx_contrasenia.Multiline = false;
            cbx_contrasenia.Name = "cbx_contrasenia";
            cbx_contrasenia.Padding = new Padding(7);
            cbx_contrasenia.PasswordChar = false;
            cbx_contrasenia.PlaceholderColor = Color.DarkGray;
            cbx_contrasenia.PlaceholderText = "";
            cbx_contrasenia.Size = new Size(181, 40);
            cbx_contrasenia.TabIndex = 14;
            cbx_contrasenia.Texts = "";
            cbx_contrasenia.UnderlinedStyle = false;
            // 
            // cbx_NombreUsuario
            // 
            cbx_NombreUsuario.BackColor = SystemColors.Window;
            cbx_NombreUsuario.BorderColor = Color.Black;
            cbx_NombreUsuario.BorderFocusColor = Color.HotPink;
            cbx_NombreUsuario.BorderRadius = 0;
            cbx_NombreUsuario.BorderSize = 2;
            cbx_NombreUsuario.Cursor = Cursors.IBeam;
            cbx_NombreUsuario.ForeColor = Color.DimGray;
            cbx_NombreUsuario.Location = new Point(426, 306);
            cbx_NombreUsuario.Multiline = false;
            cbx_NombreUsuario.Name = "cbx_NombreUsuario";
            cbx_NombreUsuario.Padding = new Padding(7);
            cbx_NombreUsuario.PasswordChar = false;
            cbx_NombreUsuario.PlaceholderColor = Color.DarkGray;
            cbx_NombreUsuario.PlaceholderText = "";
            cbx_NombreUsuario.Size = new Size(182, 40);
            cbx_NombreUsuario.TabIndex = 13;
            cbx_NombreUsuario.Texts = "";
            cbx_NombreUsuario.UnderlinedStyle = false;
            // 
            // lblContrasenia
            // 
        ...
        private Apariencia.CustomTextBox cbx_contrasenia;
        private Apariencia.CustomTextBox cbx_NombreUsuario;
